...
def broadcast(content: str) -> None:
    ...
    headers = {
        'Authorization': 'Bearer A826gnrm/xC5fRqoU4e68jq7QTUiFEs9hIgzgfBvn3EXllJvTwbs6guCg/zfhiLvDi/Ry+22GepsEx8zYCh5LdCXOlDYHCWsJpm+1qJTCzQ+HSSMuyBhsuZNjhsUTKcEEBhE2MLXZlW2M+djdOat2gdB04t89/1O/w1cDnyilFU=',
...
def getNews() -> List[Dict]:
    ...
    for i in range(0, len(news_raw), 2):
        ...
        hash_id = hashlib.sha1((title_header + title_date).encode()).hexdigest()
